            ...
            <div className="max-w-7xl mx-auto">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div className="order-2 lg:order-1">
                  ...
                  <div className="mt-8">
                    <h3 className="text-3xl font-bold mb-4 text-center lg:text-left text-yellow-400">
                      Playlist Ufficiale
                    </h3>
                ...
                <div className="order-1 lg:order-2 flex flex-col text-center lg:text-left  ">
                  ...
                  <button
                    ...
                    className="bg-green-600 hover:bg-green-700 text-white font-semibold py-3 px-6 rounded-full text-base transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl mb-4 flex items-center justify-center gap-2"
                  >
                    <svg
                      className="w-5 h-5"
                      fill="currentColor"
